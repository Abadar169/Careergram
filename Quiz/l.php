...
<head>
    ...
    <title>Which Career Path Suits You?</title>
...
<body>
    <div id="page-wrap">
        <form id="start-quiz" method="post" action="test.php">
	        ...
	        <h1 class="index-headline">Which Career Path Suits You ?</h1>
		<p class="index-sell">This quiz will act as a guidance for choosing your right career path </p>
